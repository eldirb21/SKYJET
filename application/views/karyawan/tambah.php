    ...
    <section class="wrapper">
        <div class="table-agile-info">
            <div class="panel panel-default">
                ...
                <div class="form-group row">
                    <label for="Nama" class="col-sm-2 col-form-label">Education</label>
                    <div class="col-sm-10">
                        <input type="text" name="Pendidikan" class="form-control" id="Pendidikan" value=""
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="JenisKelamin" class="form-control" id="JenisKelamin" value=""
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" name="KodePos" class="form-control" id="Username" value=""
                            placeholder="KodePos">
                        <?php echo form_error('KodePos') ?>
                        <!-- menampilkan error saat rule KodePos gagal -->
                    </div>
                </div>
                <div class="form-group row">

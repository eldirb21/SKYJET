        ...
        <div class="table-agile-info">
            <div class="panel panel-default">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Nama" class="form-control" id="Nama"
                            value="<?php echo $getData['Nama'] ?>" placeholder="Nama">
                        <?php echo form_error('Nama') ?>
                        <!-- menampilkan error saat rule Nama gagal -->
                    </div>
                </div>
                <div class="form-group row">
                    <label for="Pendidikan" class="col-sm-2 col-form-label">Education</label>
                    <div class="col-sm-10">
                        <input type="text" name="Pendidikan" class="form-control" id="Pendidikan"
                            value="<?php echo $getData['Pendidikan'] ?>" placeholder="Pendidikan">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="JenisKelamin" class="form-control" id="JenisKelamin"
                            value="<?php echo $getData['JenisKelamin'] ?>" placeholder="JenisKelamin">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Alamat" class="form-control" id="Alamat"
                            value="<?php echo $getData['Alamat'] ?>" placeholder="Alamat">
                        <?php echo form_error('Alamat') ?>
                        <!-- menampilkan error saat rule Alamat gagal -->
                    </div>
                </div>
                <div class="form-group row">
                    <label for="KodePos" class="col-sm-2 col-form-label"> Postal Code</label>
                    <div class="col-sm-10">
                        <input type="number" name="KodePos" class="form-control" id="Username"
                            value="<?php echo $getData['KodePos'] ?>" placeholder="KodePos">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="NoHp" class="form-control" id="NoHp"
                            value="<?php echo $getData['NoHp'] ?>" placeholder="NoHp">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Email" class="form-control" id="Email"
                            value="<?php echo $getData['Email'] ?>" placeholder="Email">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Hobby" class="form-control" id="Password"
                            value="<?php echo $getData['Hobby'] ?>" placeholder="Hobby">

        ...
        <div class="table-agile-info">
            <div class="panel panel-default">
                ...
                <div class="form-group row">
                    <label for="nama_barang" class="col-sm-2 col-form-label">Name of goods</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="deskripsi_barang" class="form-control" id="deskripsi_barang" value=""

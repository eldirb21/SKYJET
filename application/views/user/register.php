...
<div style="margin-left: 10%; margin-right: 20%;">
    ...
    <div class="card">
        <div class="card-header" style="background-color: #f2c318;color:white">Register Customer Gold</div>
    </div>
    ...
    <div class="form-group row">
        <label for="noTelepon" class="col-sm-2 col-form-label">No Telephone</label>
        <div class="col-sm-10">

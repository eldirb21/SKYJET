    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <h2 class="section_title">Employee</h2>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="offers_image_container">
                                ...
                                <div class="offers_image_background"
                                    style="background-image:url(<?php echo base_url() . 'img/karyawan/' . $gbr->image ?>)">
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="offers_content">
                                ...
                                <p class="offers_text">
                                <pre>Alamat : <?php echo $gbr->Alamat ?></pre>
                                </p>
                                <p class="offers_text">
                                <pre>No Hp  : <?php echo $gbr->NoHp ?></pre>
                                </p>
                                <p class="offers_text">
                                <pre>Email  : <?php echo $gbr->Email ?></pre>
                                </p>
